...
class ChessPiece {
  ...
  //     if (!(this.getStr(pieceCheckingKing.row, pieceCheckingKing.col) in this.moves)) {
  //       return {};
  //     } else {
  ...
  // handlePiecePinnedByRook = (kingParameters, board) => {
  //   let newValidMoves = {};
  ...
  //       if (piece !== 0 && (piece.pieceName === "rook" || piece.pieceName === "queen")) {
  ...
  // handlePiecePinnedByBishop = (kingParameters, board) => {
  //   let newValidMoves = {};
  ...
  //     if (piece !== 0 && piece.color === oppColor) {
  ...
  //       if (move === this.getStr(pinningPiece.row, pinningPiece.col)) {
  //         newValidMoves[move] = this.moves[move];
  //       }
  //     });
