...
const CanvasComponent: React.FC<CanvasComponentProps> = ({ roomId }) => {
    ...
    useEffect(() => {
        ...
        if (currentPainter.newPainter)
            setIsUserPainter(
                currentPainter.newPainter.username === user.username
            );
    ...
    useEffect(() => {
        ...
        socket.on(
            socketListenEvents.NEW_PAINTER_SELECTED,
            (data: CurrentPainterInfo) => {
        ...
        socket.on(
            socketListenEvents.STARTED_FILLING,
            (data: { color: string }) => {
        ...
        <div className="canvasSuperContainer">
            ...
            >
                ...
                <div style={{ minHeight: "80%" }}>
                    <ListItem
                        style={{ wordBreak: "break-all", margin: "2rem 0" }}
                    >
                        <h2>Points</h2>
                    </ListItem>
